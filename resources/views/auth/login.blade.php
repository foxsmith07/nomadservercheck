...
<body class=" bg-slate-200">
    ...
    <main class="grid grid-cols-2 h-screen">
        ...
        <section class="col-span-1 bg-[url(https://images.unsplash.com/photo-1495313196544-7d1adf4e628f?q=80&w=2071&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D)]
                        bg-cover bg-center">
