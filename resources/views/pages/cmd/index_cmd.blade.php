<x-layout>
    ...
    <form action="{{route('cmd.run')}}" class="bg-white rounded-md shadow-xl p-5 max-w-[500px] flex flex-col gap-8">
        ...
        <div class="mb-3 flex flex-col">
            ...
            <select name="train" class="input-custom">
                ...
                <option value="">All Trains IOB</option>
                <option value="">All Trains deb10</option>
