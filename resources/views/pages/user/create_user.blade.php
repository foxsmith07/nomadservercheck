<x-layout>
    ...
    <form action="{{ route('user.store') }}" method="POST" class="flex flex-col gap-5 max-w-[500px] bg-white shadow-xl rounded-md p-10">
        @csrf
        ...
        <button class="btn bg-yellow-500 text-white rounded-md hover:bg-yellow-700 p-3 mt-5">Create Collaborator</button>
    </form>
