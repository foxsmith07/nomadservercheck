<div class="flex flex-col justify-between h-full bg-slate-900">
    ...
    <div>
        ...
        <div class="flex flex-col items-start my-2 px-5 text-start text-slate-200 text-[15px]">
            ...
            <a href="{{ route('siv.index') }}" class=" hover:bg-[#4D65D9] px-3 py-2 m-0 rounded-md w-full {{Route::is('siv.*') ? 'font-extrabold text-rose-500 uppercase' : ''}}">
            ...
            <a href="{{ route('cov.index') }}" class=" hover:bg-[#4D65D9] px-3 py-2 m-0 rounded-md w-full {{Route::is('cov.*') ? 'font-extrabold text-rose-500 uppercase' : ''}}">
                {{-- <i class="fa-solid fa-screwdriver-wrench me-2"></i> --}}
                <i class="fa-solid fa-phone-volume me-3"></i>
                COV Report
            </a>

            <a href="{{ route('servizio.index') }}" class=" hover:bg-[#4D65D9] px-3 py-2 m-0 rounded-md w-full {{Route::is('servizio.*') ? 'font-extrabold text-rose-500 uppercase' : ''}}">
                {{-- <i class="fa-solid fa-screwdriver-wrench me-2"></i> --}}
                <i class="fa-solid fa-table-list me-3"></i>
                Chiusure servizio
            </a>

            <a href="{{ route('italoupgrade.index') }}" class=" hover:bg-[#4D65D9] px-3 py-2 m-0 rounded-md w-full {{Route::is('italoupgrade.*') ? 'font-extrabold text-rose-500 uppercase text-[13px]' : ''}}">
                {{-- <i class="fa-solid fa-screwdriver-wrench me-2"></i> --}}
            ...
            <a href="{{ route('movie.index') }}" class=" hover:bg-[#4D65D9] px-3 py-2 m-0 rounded-md w-full {{Route::is('movie.*') ? 'font-extrabold text-rose-500 uppercase' : ''}}">
                {{-- <i class="fa-solid fa-screwdriver-wrench me-2"></i> --}}
            ...
            <a href="{{ route('stock.index') }}" class=" hover:bg-[#4D65D9] px-3 py-2 m-0 rounded-md w-full {{Route::is('stock.*') ? 'font-extrabold text-rose-500 uppercase' : ''}}">
            ...
            <a href="{{ route('train.index') }}" class=" hover:bg-[#4D65D9] px-3 py-2 m-0 rounded-md w-full {{Route::is('train.*') ? 'font-extrabold text-rose-500 uppercase' : ''}}">
                {{-- <i class="fa-solid fa-screwdriver-wrench me-2"></i> --}}
    ...
    <div class="flex flex-col justify-end text-white h-[60px] items-center">        
